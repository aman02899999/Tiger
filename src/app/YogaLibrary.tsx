...
const POSES: Pose[] = [
  ...
  { id: "camel-prep", name: "Puppy Pose", sanskrit: "Uttana Shishosana", level: "Beginner", type: "Backbend", icon: "🐶",
    benefits: "Opens the shoulders and chest, lengthens the spine; a gentle heart-opener.",
    steps: ["From hands and knees, walk the hands forward.", "Lower the chest toward the floor, keeping the hips over the knees.", "Rest the forehead or chin down, arms active.", "Melt the chest toward the mat."],
    breath: "Breathe into the chest and shoulders; hold 5–8 breaths." },
  { id: "revolved-triangle", name: "Revolved Triangle", sanskrit: "Parivrtta Trikonasana", level: "Intermediate", type: "Standing", icon: "🔺",
    benefits: "Builds balance and strength, stretches the hamstrings, and improves spinal rotation.",
    steps: ["Stand with feet staggered, front foot forward.", "Hinge forward and place the opposite hand outside the front foot (or on a block).", "Rotate the torso, reaching the top arm to the ceiling.", "Keep the legs strong and hips level."],
    breath: "Lengthen on inhale, twist on exhale; hold 5 breaths per side." },
  { id: "crescent-lunge", name: "Crescent Lunge", sanskrit: "Anjaneyasana (high)", level: "Intermediate", type: "Standing", icon: "🌙",
    benefits: "Strengthens the legs and core, opens the hips and chest, improves balance.",
    steps: ["Step one foot back, staying on the ball of the back foot.", "Bend the front knee over the ankle.", "Reach the arms overhead, lifting the chest.", "Sink the hips down and forward."],
    breath: "Ground and lift on each breath; hold 5 breaths per side." },
  { id: "supported-bridge", name: "Supported Bridge", sanskrit: "Setu Bandha (supported)", level: "Beginner", type: "Restorative", icon: "🌉",
    benefits: "Gently opens the chest and hips; calming and restorative for the lower back.",
    steps: ["Lie on your back, knees bent, feet flat.", "Lift the hips and slide a block or bolster under the sacrum.", "Rest your weight on the support, arms relaxed.", "Let the whole body soften."],
    breath: "Slow breaths; remain 2–5 minutes, then lift off the support to release." },
  { id: "seated-wide", name: "Seated Wide-Angle Fold", sanskrit: "Upavistha Konasana", level: "Intermediate", type: "Seated", icon: "📐",
    benefits: "Stretches the inner thighs, hamstrings, and spine; calming.",
    steps: ["Sit and open the legs wide, toes pointing up.", "Sit tall, then hinge forward from the hips.", "Walk the hands forward, keeping the back long.", "Go only as far as a comfortable stretch allows."],
    breath: "Fold a little deeper on each exhale; hold 5–8 breaths." },
];
