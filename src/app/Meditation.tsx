...
let useAuth: () => { user?: { plan?: string } | null };
try {
  ...
  sitting_lotus: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <linearGradient id="body_lotus" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#7c3aed" />
            <stop offset="100%" stopColor="#4f46e5" />
          </linearGradient>
        </defs>
        <ellipse cx="100" cy="130" rx="70" ry="60" fill="url(#aura_lotus)" />
        {/* Head */}
        <circle cx="100" cy="55" r="22" fill="url(#body_lotus)" opacity="0.9" />
        {/* Torso */}
        <rect x="88" y="77" width="24" height="55" rx="8" fill="url(#body_lotus)" opacity="0.85" />
        {/* Legs crossed */}
        <ellipse cx="70" cy="165" rx="35" ry="14" fill="url(#body_lotus)" opacity="0.8" />
        <ellipse cx="130" cy="165" rx="35" ry="14" fill="url(#body_lotus)" opacity="0.8" />
        <ellipse cx="100" cy="175" rx="40" ry="10" fill="url(#body_lotus)" opacity="0.75" />
        {/* Arms on knees */}
        <ellipse cx="68" cy="155" rx="12" ry="8" fill="url(#body_lotus)" opacity="0.9" />
        <ellipse cx="132" cy="155" rx="12" ry="8" fill="url(#body_lotus)" opacity="0.9" />
        {/* Hands */}
        <circle cx="68" cy="162" r="7" fill="url(#body_lotus)" opacity="0.9" />
        <circle cx="132" cy="162" r="7" fill="url(#body_lotus)" opacity="0.9" />
        {/* Third eye dot */}
        <circle cx="100" cy="52" r="3" fill="#d8b35a" opacity="0.9" />
        {/* Glow lines */}
        <line x1="100" y1="20" x2="100" y2="5" stroke="#d8b35a" strokeWidth="1.5" opacity="0.5" />
        <line x1="115" y1="25" x2="125" y2="12" stroke="#d8b35a" strokeWidth="1" opacity="0.4" />
        <line x1="85" y1="25" x2="75" y2="12" stroke="#d8b35a" strokeWidth="1" opacity="0.4" />
      </svg>
    ),
    breathing_deep: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="body_breath" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#7c3aed" />
            <stop offset="100%" stopColor="#6d28d9" />
          </linearGradient>
        </defs>
        {/* Breath circles */}
        <circle cx="100" cy="125" r="75" fill="none" stroke="#7c3aed" strokeWidth="1" opacity="0.2" />
        <circle cx="100" cy="125" r="55" fill="none" stroke="#7c3aed" strokeWidth="1" opacity="0.3" />
        <circle cx="100" cy="125" r="35" fill="none" stroke="#7c3aed" strokeWidth="1" opacity="0.4" />
        {/* Head */}
        <circle cx="100" cy="50" r="22" fill="url(#body_breath)" opacity="0.9" />
        {/* Torso expanded */}
        <path d="M82 72 Q100 70 118 72 L120 140 Q100 145 80 140 Z" fill="url(#body_breath)" opacity="0.85" />
        {/* Arms on belly */}
        <path d="M82 115 Q60 118 50 125" stroke="url(#body_breath)" strokeWidth="14" strokeLinecap="round" fill="none" opacity="0.85" />
        <path d="M118 115 Q140 118 150 125" stroke="url(#body_breath)" strokeWidth="14" strokeLinecap="round" fill="none" opacity="0.85" />
        {/* Hands on belly */}
        <circle cx="50" cy="125" r="8" fill="url(#body_breath)" opacity="0.9" />
        <circle cx="150" cy="125" r="8" fill="url(#body_breath)" opacity="0.9" />
        {/* Legs */}
        <path d="M85 140 L75 200" stroke="url(#body_breath)" strokeWidth="16" strokeLinecap="round" fill="none" opacity="0.8" />
        <path d="M115 140 L125 200" stroke="url(#body_breath)" strokeWidth="16" strokeLinecap="round" fill="none" opacity="0.8" />
        {/* Breath arrow */}
        <path d="M100 20 L100 8" stroke="#d8b35a" strokeWidth="2" markerEnd="url(#arrow)" opacity="0.7" />
      </svg>
    ),
    body_scan: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="body_scan_g" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#d8b35a" />
        ...
        {/* Lying figure */}
        {/* Head */}
        <circle cx="35" cy="130" r="20" fill="url(#body_scan_g)" opacity="0.9" />
        {/* Body */}
        <rect x="50" y="118" width="110" height="24" rx="12" fill="url(#body_scan_g)" opacity="0.85" />
        {/* Legs */}
        <rect x="158" y="120" width="35" height="14" rx="7" fill="url(#body_scan_g)" opacity="0.8" />
        {/* Arms beside body */}
        <rect x="60" y="142" width="90" height="10" rx="5" fill="url(#body_scan_g)" opacity="0.75" />
        {/* Scan line */}
        <line x1="30" y1="100" x2="185" y2="100" stroke="#d8b35a" strokeWidth="2" opacity="0.6" strokeDasharray="6,3" />
        {/* Awareness dots */}
        <circle cx="35" cy="130" r="4" fill="#d8b35a" opacity="0.9" />
        <circle cx="80" cy="125" r="4" fill="#d8b35a" opacity="0.8" />
        <circle cx="120" cy="125" r="4" fill="#d8b35a" opacity="0.7" />
        <circle cx="160" cy="125" r="4" fill="#d8b35a" opacity="0.6" />
      </svg>
    ),
    loving_kindness: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="body_lk" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#ec4899" />
            <stop offset="100%" stopColor="#7c3aed" />
          </linearGradient>
        </defs>
        {/* Hearts radiating */}
        <text x="30" y="40" fontSize="18" fill="#ec4899" opacity="0.3">♥</text>
        <text x="155" y="50" fontSize="14" fill="#ec4899" opacity="0.4">♥</text>
        <text x="20" y="90" fontSize="10" fill="#ec4899" opacity="0.3">♥</text>
        <text x="168" y="95" fontSize="12" fill="#ec4899" opacity="0.35">♥</text>
        {/* Head */}
        <circle cx="100" cy="60" r="22" fill="url(#body_lk)" opacity="0.9" />
        {/* Torso */}
        <rect x="88" y="82" width="24" height="55" rx="8" fill="url(#body_lk)" opacity="0.85" />
        {/* Arms crossed on heart */}
        <path d="M88 100 Q65 95 55 105" stroke="url(#body_lk)" strokeWidth="14" strokeLinecap="round" fill="none" opacity="0.85" />
        <path d="M112 100 Q135 95 145 105" stroke="url(#body_lk)" strokeWidth="14" strokeLinecap="round" fill="none" opacity="0.85" />
        {/* Hands on heart */}
        <circle cx="55" cy="105" r="8" fill="url(#body_lk)" opacity="0.9" />
        <circle cx="145" cy="105" r="8" fill="url(#body_lk)" opacity="0.9" />
        {/* Heart on chest */}
        <text x="90" y="108" fontSize="14" fill="#d8b35a">♥</text>
        {/* Legs */}
        <ellipse cx="80" cy="175" rx="30" ry="12" fill="url(#body_lk)" opacity="0.8" />
        <ellipse cx="120" cy="175" rx="30" ry="12" fill="url(#body_lk)" opacity="0.8" />
        <ellipse cx="100" cy="183" rx="35" ry="9" fill="url(#body_lk)" opacity="0.75" />
      </svg>
    ),
    walking: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="body_walk" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#7c3aed" />
            <stop offset="100%" stopColor="#4f46e5" />
          </linearGradient>
        </defs>
        {/* Ground line */}
        <line x1="20" y1="230" x2="180" y2="230" stroke="#7c3aed" strokeWidth="2" opacity="0.3" />
        {/* Head */}
        <circle cx="90" cy="50" r="22" fill="url(#body_walk)" opacity="0.9" />
        {/* Torso slight lean */}
        <path d="M85 72 Q95 70 105 72 L108 140 Q95 143 82 140 Z" fill="url(#body_walk)" opacity="0.85" />
        {/* Left arm forward */}
        <path d="M105 90 Q125 100 135 120" stroke="url(#body_walk)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        {/* Right arm back */}
        <path d="M85 90 Q65 100 55 115" stroke="url(#body_walk)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        {/* Hands */}
        <circle cx="135" cy="120" r="7" fill="url(#body_walk)" opacity="0.9" />
        <circle cx="55" cy="115" r="7" fill="url(#body_walk)" opacity="0.9" />
        {/* Left leg forward */}
        <path d="M95 140 Q100 175 110 220" stroke="url(#body_walk)" strokeWidth="16" strokeLinecap="round" fill="none" opacity="0.8" />
        {/* Right leg back */}
        <path d="M85 140 Q75 170 65 210" stroke="url(#body_walk)" strokeWidth="16" strokeLinecap="round" fill="none" opacity="0.8" />
        {/* Mindfulness aura */}
        <circle cx="90" cy="50" r="30" fill="none" stroke="#d8b35a" strokeWidth="1" opacity="0.3" strokeDasharray="4,4" />
      </svg>
    ),
    visualization: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="body_vis" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#7c3aed" />
            <stop offset="100%" stopColor="#4f46e5" />
          </linearGradient>
        </defs>
        {/* Thought bubble */}
        <circle cx="130" cy="25" r="18" fill="#1e1b4b" stroke="#7c3aed" strokeWidth="1.5" opacity="0.8" />
        <text x="122" y="30" fontSize="16" fill="#d8b35a">✨</text>
        <circle cx="118" cy="47" r="5" fill="#7c3aed" opacity="0.5" />
        <circle cx="110" cy="58" r="3" fill="#7c3aed" opacity="0.4" />
        {/* Head */}
        <circle cx="100" cy="80" r="22" fill="url(#body_vis)" opacity="0.9" />
        {/* Torso */}
        <rect x="88" y="102" width="24" height="55" rx="8" fill="url(#body_vis)" opacity="0.85" />
        {/* Arms relaxed */}
        <path d="M88 115 Q70 125 60 140" stroke="url(#body_vis)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        <path d="M112 115 Q130 125 140 140" stroke="url(#body_vis)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        <circle cx="60" cy="140" r="7" fill="url(#body_vis)" opacity="0.9" />
        <circle cx="140" cy="140" r="7" fill="url(#body_vis)" opacity="0.9" />
        {/* Legs */}
        <ellipse cx="80" cy="193" rx="30" ry="12" fill="url(#body_vis)" opacity="0.8" />
        <ellipse cx="120" cy="193" rx="30" ry="12" fill="url(#body_vis)" opacity="0.8" />
        <ellipse cx="100" cy="200" rx="35" ry="9" fill="url(#body_vis)" opacity="0.75" />
      </svg>
    ),
    focused_attention: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="body_fa" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#7c3aed" />
            <stop offset="100%" stopColor="#4f46e5" />
          </linearGradient>
        </defs>
        {/* Focus target */}
        <circle cx="100" cy="20" r="12" fill="none" stroke="#d8b35a" strokeWidth="2" opacity="0.8" />
        <circle cx="100" cy="20" r="6" fill="none" stroke="#d8b35a" strokeWidth="2" opacity="0.9" />
        <circle cx="100" cy="20" r="2" fill="#d8b35a" opacity="1" />
        {/* Arrow from head to target */}
        <line x1="100" y1="52" x2="100" y2="34" stroke="#d8b35a" strokeWidth="2" opacity="0.6" />
        {/* Head */}
        <circle cx="100" cy="65" r="22" fill="url(#body_fa)" opacity="0.9" />
        {/* Third eye */}
        <circle cx="100" cy="62" r="3" fill="#d8b35a" />
        {/* Torso */}
        <rect x="88" y="87" width="24" height="55" rx="8" fill="url(#body_fa)" opacity="0.85" />
        {/* Arms in dhyana mudra */}
        <path d="M88 120 Q70 128 62 135" stroke="url(#body_fa)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        <path d="M112 120 Q130 128 138 135" stroke="url(#body_fa)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        <ellipse cx="100" cy="138" rx="22" ry="8" fill="url(#body_fa)" opacity="0.85" />
        {/* Legs */}
        <ellipse cx="80" cy="178" rx="30" ry="12" fill="url(#body_fa)" opacity="0.8" />
        <ellipse cx="120" cy="178" rx="30" ry="12" fill="url(#body_fa)" opacity="0.8" />
        <ellipse cx="100" cy="185" rx="35" ry="9" fill="url(#body_fa)" opacity="0.75" />
      </svg>
    ),
    open_monitoring: (
      <svg viewBox="0 0 200 250" width={size} height={size} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="body_om" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#7c3aed" />
            <stop offset="100%" stopColor="#4f46e5" />
          </linearGradient>
        </defs>
        ...
        {[0, 45, 90, 135, 180, 225, 270, 315].map((angle, i) => (
          <line
            key={i}
            x1={100 + 30 * Math.cos((angle * Math.PI) / 180)}
            y1={70 + 30 * Math.sin((angle * Math.PI) / 180)}
            x2={100 + 55 * Math.cos((angle * Math.PI) / 180)}
            y2={70 + 55 * Math.sin((angle * Math.PI) / 180)}
            stroke="#d8b35a"
            strokeWidth="1.5"
            opacity="0.4"
          />
        ...
        {/* Head */}
        <circle cx="100" cy="70" r="22" fill="url(#body_om)" opacity="0.9" />
        {/* Torso */}
        <rect x="88" y="92" width="24" height="55" rx="8" fill="url(#body_om)" opacity="0.85" />
        {/* Arms open wide */}
        <path d="M88 105 Q65 100 45 110" stroke="url(#body_om)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        <path d="M112 105 Q135 100 155 110" stroke="url(#body_om)" strokeWidth="13" strokeLinecap="round" fill="none" opacity="0.85" />
        <circle cx="45" cy="110" r="8" fill="url(#body_om)" opacity="0.9" />
        <circle cx="155" cy="110" r="8" fill="url(#body_om)" opacity="0.9" />
        {/* Legs crossed */}
        <ellipse cx="80" cy="178" rx="30" ry="12" fill="url(#body_om)" opacity="0.8" />
        <ellipse cx="120" cy="178" rx="30" ry="12" fill="url(#body_om)" opacity="0.8" />
