    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6">
          ...
          <div className="flex justify-between gap-1.5">
            {MOODS.map((m) => (
              <button
                ...
                className={`flex flex-1 flex-col items-center gap-1 rounded-xl border py-3 transition ${moodId === m.id ? "scale-105 border-white/30 bg-white/10" : "border-transparent hover:bg-white/5"}`}
        ...
        <button
          ...
          onClick={save}
          disabled={!moodId}
          className="btn-gloss mt-5 w-full rounded-full bg-gradient-to-r from-violet-300 via-fuchsia-500 to-violet-700 py-3 text-xs font-black uppercase tracking-[0.16em] text-white disabled:cursor-not-allowed disabled:opacity-40"
        >
