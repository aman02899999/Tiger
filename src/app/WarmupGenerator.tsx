  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6">
        ...
        <button type="button" onClick={generate} className="btn-gloss mt-4 w-full rounded-full bg-gradient-to-r from-violet-300 via-fuchsia-500 to-violet-700 py-3 text-xs font-black uppercase tracking-[0.16em] text-white">Generate My Warm-Up</button>
      </div>
