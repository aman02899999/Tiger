...
| 4 | Executable proofs: permission matrix, tenant isolation, entitlement read-only, webhook signatures, rules invariants | ✅ `scripts/test-saas.mjs` — 64 assertions, green |
